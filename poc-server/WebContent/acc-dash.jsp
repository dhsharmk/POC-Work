				...
				<div class="form-row">
					<div class="col-11">
						<input type="text" class="form-control my-1" name="customerName"
							...
							value="<%= request.getAttribute("CUSTOMER_NAME") %>">
					</div>
					<div class="col-1">
					...
					<div class="col-11">
						<input type="number" class="form-control my-1"
							...
							value="<%= request.getAttribute("CUSTOMER_MOB") %>">
					</div>
					<div class="col-1"></div>
					<div class="col-11">
							...
							<form class="text-center" style="color: #757575;"
								...
								<div class="md-form">
									<input type="text" id="cname" class="form-control"
										name="customerName" value="<%= request.getAttribute("CUSTOMER_NAME") %>"> <label for="cname">Customer
										Name</label>
									<button type="button" id="cnamemic">
										<i class="fa fa-microphone" aria-hidden="true"></i>
									</button>
								...
								<div class="md-form">
									<input type="number" id="cmob" class="form-control"
										name="customerMobile" value="<%= request.getAttribute("CUSTOMER_MOB") %>"> <label for="cmob">Customer
										Mobile</label>
								</div>
